...
String _dropdownValue = "YoptaScript";
    ...
    return Form(
        ...
        child: Column(
            ...
            children: <Widget>[
              ...
              Container(padding: EdgeInsets.fromLTRB(20, 20, 0, 0),child: CheckboxListTile(value: isChecked, title: const Text("Я чел"), controlAffinity: ListTileControlAffinity.leading,onChanged: (bool? value) {setState(() => isChecked = value!);}),),
